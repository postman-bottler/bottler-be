...
class SubscriptionRepositoryImplTest {
    ...
    void save() {
        ...
        // then
        assertThat(save.getDevice().getUserId()).isEqualTo(1L);
        assertThat(save.getDevice().getToken()).isEqualTo("token");
    ...
    void isDuplicateWithDuplicateSubscription() {
        ...
        // when
        Boolean result = subscriptionRepository.isDuplicate(subscription.getDevice());
    ...
    void isDuplicate() {
        ...
        // when
        Boolean result = subscriptionRepository.isDuplicate(notDuplicateSubscription.getDevice());
